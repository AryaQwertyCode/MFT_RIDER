                ...
                override fun onResponse(call: Call<UserModel>, response: Response<UserModel>) {
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (userModel.status) {
                            ...
                            edit.putString(this@OtpActivity.resources.getString(R.string.access_token), userModel.result.token)
                            Log.d(TAG, "Access_Token_OTP: ${userModel.result.token}")
                            edit.putString(
                                "mobile",
                                userModel.result.mobile
                            )

                          //  edit.putString("access_token",userModel.result.token)
