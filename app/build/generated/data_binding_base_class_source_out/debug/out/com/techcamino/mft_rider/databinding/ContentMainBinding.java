...
public final class ContentMainBinding implements ViewBinding {
  ...
  @NonNull
  public final DashboardBinding dashboard;

  private ContentMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull DashboardBinding dashboard) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.dashboard;
      View dashboard = ViewBindings.findChildViewById(rootView, id);
      if (dashboard == null) {
        break missingId;
      }
      DashboardBinding binding_dashboard = DashboardBinding.bind(dashboard);

      return new ContentMainBinding((ConstraintLayout) rootView, binding_dashboard);
    }
